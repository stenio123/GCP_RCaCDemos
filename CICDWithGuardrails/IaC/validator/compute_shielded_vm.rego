...
deny[{
	...
	lib.get_default(instance, "enable_secure_boot", true) == true
	lib.get_default(instance, "enable_vtpm", true) == true
	lib.get_default(instance, "enable_integrity_monitoring", true) == true
	...
	message := sprintf("%v does not have shielded VM options enabled.", [asset.name])
